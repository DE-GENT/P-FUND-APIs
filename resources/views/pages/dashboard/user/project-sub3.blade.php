                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="input-with-prefix">
                                    ...
                                    <input type="number" id="total_cost" class="form-control" placeholder="0.00" min="0" step="any">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-prefix">
                                    <span class="prefix">$</span>
                                    <input type="number" id="funding_request" class="form-control" placeholder="0.00" min="0" step="any">
                                </div>
